...
<head>
    ...
    <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo(); ?>"
    ...
    <header class="main-header" id="alert">
        <a href="<?php echo base_url(); ?>user/user/dashboard" class="logo">
            <span class="logo-mini"><img
                        src="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo(); ?>"
            ...
            <div class="col-lg-7 col-md-9 col-sm-10 col-xs-8">
                <div class="pull-right">
                    ...
                    <div class="navbar-custom-menu">
                        <div class="langdiv">
                            <select class="languageselectpicker" onchange="set_languages(this.value)" type="text"
                                    id="languageSwitcher" class="form-control search-form search-form3 langselect">
                        ...
                        <ul class="nav navbar-nav headertopmenu">
                            ...
                            if ($this->studentmodule_lib->hasActive('multi_class')) {
                                ?>
                                <li class="cal15"><a href="#" data-toggle="modal" data-target="#classSwitchModal"><i
                                                class="fa fa-exchange" aria-hidden="true"></i></a></li>
                                <?php
                            ...
                            <?php if ($this->studentmodule_lib->hasActive('calendar_to_do_list')) { ?>
                                <li class="cal15"><a href="<?php echo base_url() ?>user/calendar/"><i
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu menuboxshadow">
                                        ...
                                        <li class="todoview plr10 ssnoti"><?php echo "Today you have " . $count . " pending task." ?>
                                            <a href="<?php echo base_url() ?>user/calendar/"
                                               class="pull-right pt0"> <?php echo $this->lang->line('view') . " " . $this->lang->line('all'); ?></a>
                                        </li>
                                        <li>
                                            <ul class="todolist">
                                                <?php
                                                    ...
                                                    <li>
                                                        <div class="checkbox">
                                                            <label><input type="checkbox"
                                                                          ...
                                                                          name="eventcheck"
                                                                          value="<?php echo $value["id"]; ?>"><?php echo $value["event_title"] ?>
                                                            </label>
                                                        </div>
                                                    </li>
                                                <?php } ?>
                            ...
                            if ($this->studentmodule_lib->hasActive('chat')) {
                                ?>
                                <li class="cal15"><a data-placement="bottom" data-toggle="tooltip" title=""
                                                     href="<?php echo base_url() ?>user/chat" data-original-title="Chat"
                                                     class="todoicon"><i class="fa fa-whatsapp"></i></a></li>
                            <?php }
                                ...
                                <ul class="dropdown-menu dropdown-user menuboxshadow">
                                    ...
                                    <li>
                                        <div class="sstopuser">
                                            ...
                                            <div class="sspass">
                                                <a class="" href="<?php echo base_url(); ?>user/user/changepass"><i
                                                            class="fa fa-key"></i> <?php echo $this->lang->line('change_password'); ?>
                                                </a> <a class="pull-right"
                                                        href="<?php echo base_url(); ?>site/logout"><i
                                                            class="fa fa-sign-out fa-fw"></i> <?php echo $this->lang->line('logout'); ?>
                                                </a>
                                            </div>
                                        </div><!--./sstopuser--></li>
        ...
        <section class="sidebar">
            ...
            <ul class="sessionul fixedmenu">
                ...
                <li class="removehover accurrent">
                    <a data-toggle="modal"
                       data-target="#user_sessionModal"><span><?php echo $this->lang->line('current_session') . ": " . $this->setting_model->getCurrentSessionName(); ?></span><i
            ...
            <ul class="sidebar-menu verttop38" id="sibe-box">
                ...
                <li class="<?php echo set_Topmenu('Dashboard'); ?>"><a
                            href="<?php echo base_url(); ?>user/user/dashboard"><i class="fa fa-user-plus ftlayer"></i>
                        <span><?php echo $this->lang->line('my_profile'); ?></span></a></li>
                <?php
                if ($this->studentmodule_lib->hasActive('fees')) {
                    ?>
                    <li class="<?php echo set_Topmenu('fees'); ?>"><a href="<?php echo base_url(); ?>user/user/getfees"><i
                                    class="fa fa-money ftlayer"></i>
                            <span><?php echo $this->lang->line('fees'); ?></span></a></li>
                    <?php
                }
                ?>
                <?php
                if ($this->module_lib->hasModule('zoom_live_classes')) {
                    if ($this->studentmodule_lib->hasActive('live_classes')) {
                        ?>
                        <li class="<?php echo set_topmenu('Conference'); ?>"><a
                                    href="<?php echo base_url('user/conference'); ?>"><i
                                        class="fa fa-video-camera ftlayer"></i> <?php echo $this->lang->line('live_class'); ?>
                            </a></li>
                    <?php }
                } ?>
                <?php
                if ($this->module_lib->hasModule('gmeet_live_classes')) {
                    if ($this->studentmodule_lib->hasActive('gmeet_live_classes')) {
                        ?>
                        <li class="<?php echo set_topmenu('Gmeet'); ?>"><a href="<?php echo base_url('user/gmeet'); ?>"><i
                                        class="fa fa-video-camera ftlayer"></i> <?php echo $this->lang->line('gmeet') . " " . $this->lang->line('live_class'); ?>
                            </a></li>
                    <?php }
                } ?>
                <?php
                ...
                if ($this->studentmodule_lib->hasActive('class_timetable')) {
                    ...
                    <li class="<?php echo set_Topmenu('Time_table'); ?>"><a
                                href="<?php echo base_url(); ?>user/timetable"><i
                                    class="fa fa-calendar-plus-o ftlayer"></i>
                            <span><?php echo $this->lang->line('class_timetable'); ?></span></a></li>
                    <?php
                } ?>

                <li><a
                            href="<?php echo base_url(); ?>user/user/schedule?date_start=<?=date('Y-m-d')?>"><i
                ...
                if ($this->studentmodule_lib->hasActive('lesson_plan')) {
                    ...
                    <li class="<?php echo set_Topmenu('syllabus'); ?>"><a href="<?php echo base_url(); ?>user/syllabus"><i
                                    class="fa fa fa-list-alt ftlayer"></i>
                            <span><?php echo $this->lang->line('lesson_plan'); ?></span></a></li>

                <?php }
                if ($this->studentmodule_lib->hasActive('syllabus_status')) {
                    ?>
                    <li class="<?php echo set_Topmenu('syllabus/status'); ?>"><a
                                href="<?php echo base_url(); ?>user/syllabus/status"><i
                                    class="fa fa-list-ol ftlayer"></i>
                            <span><?php echo $this->lang->line('syllabus') . " " . $this->lang->line('status'); ?></span></a>
                    </li>
                    <?php
                }
                if ($this->studentmodule_lib->hasActive('homework')) {
                    ?>
                    <li class="<?php echo set_Topmenu('Homework'); ?>"><a href="<?php echo base_url(); ?>user/homework"><i
                                    class="fa fa-flask ftlayer"></i>
                            <span><?php echo $this->lang->line('homework'); ?></span></a></li>
                    <?php
                }
                if ($this->studentmodule_lib->hasActive('online_examination')) {
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Onlineexam'); ?>"><a
                                href="<?php echo site_url('user/onlineexam'); ?>"><i class="fa fa-rss ftlayer"></i>
                            <span><?php echo $this->lang->line('online') . " " . $this->lang->line('exam'); ?></span></a>
                    </li>
                ...
                if ($this->studentmodule_lib->hasActive('apply_leave')) {
                    ...
                    <li class="<?php echo set_Topmenu('apply_leave'); ?>"><a
                                href="<?php echo base_url(); ?>user/apply_leave"><i
                                    class="fa fa-check-square ftlayer"></i>
                            <span><?php echo $this->lang->line('apply_leave'); ?></span></a></li>
                <?php }
                if ($this->studentmodule_lib->hasActive('download_center')) {
                    ?>
                    <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                        <a href="#">
                            <i class="fa fa-download ftlayer"></i>
                            <span><?php echo $this->lang->line('download_center'); ?></span> <i
                                    class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('content/assignment'); ?>"><a
                                        href="<?php echo base_url(); ?>user/content/assignment"><i
                                            class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('assignments'); ?>
                                </a></li>
                            <li class="<?php echo set_Submenu('content/studymaterial'); ?>"><a
                                        href="<?php echo base_url(); ?>user/content/studymaterial"><i
                                            class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('study_material'); ?>
                                </a></li>
                            <li class="<?php echo set_Submenu('content/syllabus'); ?>"><a
                                        href="<?php echo base_url(); ?>user/content/syllabus"><i
                                            class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('syllabus'); ?>
                                </a></li>
                            <li class="<?php echo set_Submenu('content/other'); ?>"><a
                                        href="<?php echo base_url(); ?>user/content/other"><i
                                            class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('other_downloads'); ?>
                                </a></li>
                        </ul>
                    </li>
                    <?php
                ...
                if ($this->studentmodule_lib->hasActive('attendance')) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('Attendence'); ?>"><a
                                href="<?php echo base_url(); ?>user/attendence"><i
                                    class="fa fa-calendar-check-o ftlayer"></i>
                            <span><?php echo $this->lang->line('attendance'); ?></span></a></li>
                    <?php
                }
                ...
                if ($this->studentmodule_lib->hasActive('examinations')) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        <a href="#">
                            <i class="fa fa-map-o ftlayer"></i>
                            <span><?php echo $this->lang->line('examinations'); ?></span> <i
                                    class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                ...
                if ($this->studentmodule_lib->hasActive('notice_board')) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('notification'); ?>">
                        <a href="<?php echo base_url(); ?>user/notification">
                            <i class="fa fa-envelope ftlayer"></i>
                ...
                if ($this->studentmodule_lib->hasActive('teachers_rating')) {
                    ...
                    <li class="<?php echo set_Topmenu('Teachers'); ?>"><a
                                href="<?php echo base_url(); ?>user/teacher"><i class="fa fa-user-secret ftlayer"></i>
                            <span><?php echo $this->lang->line('teachers') . " " . $this->lang->line('reviews'); ?></span></a>
                    </li>
                    <?php
                }
                        ...
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('book/index'); ?>">
                                <a href="<?php echo base_url(); ?>user/book">
                                    <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('books'); ?>
                                </a>
                            </li>
                            <li class="<?php echo set_Submenu('book/issue'); ?>">
                                <a href="<?php echo base_url(); ?>user/book/issue">
                                    <i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('book_issued'); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                if ($this->studentmodule_lib->hasActive('transport_routes')) {
                    ?>
                    <li class="<?php echo set_Submenu('route/index'); ?>"><a href="<?php echo base_url(); ?>user/route"><i
                                    class="fa fa-bus ftlayer"></i>
                            <span><?php echo $this->lang->line('transport_routes'); ?></span></a></li>
                    <?php
                }
                if ($this->studentmodule_lib->hasActive('hostel_rooms')) {
                    ?>
                    <li class="<?php echo set_Submenu('hostelroom/index'); ?>"><a
                                href="<?php echo base_url(); ?>user/hostelroom"><i class="fa fa-building-o ftlayer"></i>
                            <span><?php echo $this->lang->line('hostel_rooms'); ?></span></a></li>
