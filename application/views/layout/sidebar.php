                ...
                <li class="treeview <?php echo set_Topmenu('schedules'); ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if ($this->rbac->hasPrivilege('schedule', 'can_view')) : ?>
                            <li class="<?php echo set_Submenu('admin/schedule'); ?>"><a href="<?php echo base_url(); ?>admin/schedule?date_start=<?=date('Y-m-d')?>&date_end=<?=date('Y-m-d')?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('schedule_collection_list'); ?></a></li>
                        <?php endif; ?>
