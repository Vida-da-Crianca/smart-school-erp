                        ...
                        <div class="">
                                ...
                                <div class="around10">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input autofocus="" id="admission_no" 
                                                                       name="admission_no" placeholder="" type="text" class="form-control" 
                                    ...
                                    <div class = "row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Período</label><small class="req"> *</small>
                                         ...
                                         <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="admission_date" 
                                                           name="admission_date" placeholder="" type="text" class="form-control" 
                                                           value="<?php echo $this->tools->formatarData($obj->admission_date,'us','br'); ?>" readonly="readonly" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_name" name="father_name" placeholder="" type="text" 
                                                           class="form-control" value="<?php echo $obj->father_name; ?>" />
							...
							$nf = str_replace(")","", $nf);?>
                                                    ...
                                                    <input id="father_phone" name="father_phone" placeholder="" type="text" 
                                                           class="form-control" value="<?php echo $obj->father_phone; ?>" />
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="guardian_relation" 
                                                       name="guardian_relation" placeholder="Avô/avó/tio(a) etc..." type="text"
                                                       class="form-control" value="<?php echo $obj->guardian_relation; ?>" />
							...
							$nf = str_replace(")","", $nf);?>
                                                           ...
                                                           onclick="callwz(<?php echo $nf; ?>);"></i>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php echo $this->lang->line('guardian_phone'); ?></label><small class="req"> *</small>
                                ...
                                <div class="around10">
                                    <div class="row">
                                        ...
                                        <label for="exampleInputEmail1">&nbsp;</label>
                                            ...
                                            id="trigger-cep" data-target="guardian_postal_code"  style="padding: 3.8px 15px;" 
                                            type="button" class="btn btn-primary">Pesquisar endereco</button>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input maxlength="30" id="guardian_address" 
                                                   ...
                                                   disabled="disabled"
                                                   placeholder="Rua, avenida, travessa etc.." class="form-control documento" 
                                    ...
                                    <div class = "row">
                                        ...
                                        <div class="col-md-2">
                                                ...
                                                <input maxlength="20" id="guardian_city" name="guardian_city"
                                                       placeholder="Barretos" class="form-control documento"   disabled="disabled"
                                        ...
                                        <div class = "row">
                                            <?php foreach($documentos as $campo => $label): ?>
                                                <div class = "col-md-3 col-xs-12 col-sm-3">
                                                    ...
                                                    <a href="<?php echo base_url('uploads/student_documents/'.((int)$obj->id).'/'.$documentosEnviados[$label]); ?>" target="_blank">
                                            ...
                                            <?php for($i = 1; $i <= 4; $i++): ?>
                                                <div class="col-md-3">
                                                    ...
                                                    <?php if($action != 'add' && isset($documentosEnviadosExtraEnviados[$i])): ?>
                                                            <a href="<?php echo base_url('uploads/student_documents/'.((int)$obj->id).'/'.$documentosEnviadosExtraEnviados[$i]->doc); ?>" target="_blank">
                                                                <i class="fa fa-external-link"></i>
                                                            </a>
                                                        <?php endif; ?>
                                                    
                                                    </label><br />
                                                    <input type="text" name="doc_titulo_<?php echo $i; ?>" class="form-control" id="doc_titulo_<?php echo $i; ?>"
                                                           value="<?php echo isset($documentosEnviadosExtraEnviados[$i]) ? $documentosEnviadosExtraEnviados[$i]->title : ''; ?>"
                                                           />
                                                    <input type="text" name="doc_arquivo_<?php echo $i; ?>"  id="doc_arquivo_<?php echo $i; ?>"
