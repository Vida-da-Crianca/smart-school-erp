 <?php 
                                          ...
                                          $session=$this->session->userdata('student');
                                           ...
                                           //print_r($defoultlang['lang_id']);die;
                                          ...
                                          $json_languages=json_decode($lang[0]['languages']);
                                                ...
                                                foreach($json_languages as $value){
                                                    ...
                                                    ?>
                                                    <option data-content='<span class="flag-icon flag-icon-<?php echo $result['country_code'];?>"></span> <?php echo $result['language'];?>' value="<?php echo $value;?>" <?php if($defoult==$value){ echo "Selected";} ?>><?php echo $result['language'];?></option>
                                                    <?php
