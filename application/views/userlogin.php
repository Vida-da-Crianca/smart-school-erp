                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                        <div class="loginbg loginradius login390">
                            ...
                            <div class="form-bottom">
                                ...
                                <p style="margin-top: 10px;"><a style="color:#0;" target="_blank"
                                                                href="<?php echo base_url('site/login'); ?>"
                                                                class="forgot pull-right"> <i class="fa fa-user"></i>
                                        Portal Colaborador</a> <a style="color:#0;padding-right: 20px;" href="/"
                                                                  target="_blank" class="forgot pull-right"> <i
                                                class="fa fa-empire"></i> Home Site</a>
                                </p>

                                <p><a href="<?php echo site_url('site/ufpassword') ?>" class="forgot"> <i
                                                class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?>
                                    </a></p>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function setMask(){
        let text  =  $('#user_name').val()
        if (text){
            let letter  = text.charAt(0);
            if (!isLetter(letter)){
                $('#user_name').mask('000.000.000-00')
            }else{
                $('#user_name').unmask();
            }
        }else{
