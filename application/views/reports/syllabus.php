...
<div class="content-wrapper">
                                    ...
                                    <?php foreach ($subjects_data as $key => $value) {
                                        ...
                                        <div class="col-md-2 col-xs-6 systatus">
                                            ...
                                            <div class="chart ptt10">
                                             ...
                                             <span class="label lbcolor"><?php echo $this->lang->line('complete') . " " . $value['complete'] . " %"; ?></span><!-- <span class="label" style="background:#cfcfcf;"><?php //echo $this->lang->line('incomplete')." ".$value['incomplete']." %";   ?></span> -->  
                                        </div>
                                    <?php }
                                    ?>
                    ...
                    <div class="table-responsive" id="transfee">
                        ...
                        <table class="table table-bordered topicstaus" id="headerTable">
                            ...
                            <tr class="hide" id="visible">
                                <td colspan="2"><center><b><?php echo $this->lang->line('syllabus_status_report'); ?></b></center></td>
                            </tr>
    ...
    ?>
                <div class=" active table-responsive no-padding" >
                    <div class="download_label"> <?php echo $this->lang->line('syllabus_status_report'); ?></div>
                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" >
                        <thead>
                            <tr>
                                <th ><?php echo $this->lang->line('subject') . " - " . $this->lang->line('lesson'); ?> - <?php echo $this->lang->line('topic'); ?>
                                </th>
