                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('total') . " " . $this->lang->line('assigned') . " " . $this->lang->line('teachers'); ?></th>
                                        <th><?php echo $this->lang->line('student') . "-" . $this->lang->line('teacher') . " " . $this->lang->line('ratio'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $total_boys = $total_girls = $total_students = $all_teacher = 0;
                                    foreach ($result as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['total_teacher']; ?></td>
                                            <td><?php echo $value['teacher_ratio'] ?></td>
                                        </tr>
                                        <?php
