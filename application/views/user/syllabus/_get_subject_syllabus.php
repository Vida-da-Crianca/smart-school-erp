			...
			<div class="classtopic">
				<ul class="classlist ">
					...
					<?php if($result['attachment']!=''){
						?>
						<li><a data-original-title="<?php echo $this->lang->line('download_attachment')?>" data-toggle="tooltip" href="<?php echo base_url()?>user/syllabus/download/<?php echo $result['attachment']?>"><i class="fa fa-file-text-o"></i></a></li>
						<?php
					}
				...
				if($result['lacture_video']!=''){ ?>
					<li><a data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download_video')?>" href="<?php echo base_url()?>user/syllabus/lacture_video_download/<?php echo $result['lacture_video']?>"><i class="fa fa-file-video-o"></i></a></li>
					<?php }?>
