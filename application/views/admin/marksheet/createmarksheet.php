                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('marksheet'); ?></h3>
                        </div><!-- /.box-header -->
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/marksheet') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="heading" value="<?php echo set_value('heading'); ?>" name="heading" placeholder="" type="text" class="form-control" />
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <textarea name="content" type="text" class="form-control"><?php echo set_value('content'); ?></textarea>
                                ...
                                <div class="form-group switch-inline">
                                    ...
                                    <div class="material-switch switchcheck">
                                        <input id="is_division" name="is_division" type="checkbox" class="chk" value="1">
            ...
            ?>">
                ...
                <div class="box box-primary" id="hroom">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('marksheet'); ?> <?php echo $this->lang->line('list'); ?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"> <?php echo $this->lang->line('marksheet'); ?> <?php echo $this->lang->line('list'); ?></div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if ($certificate->background_img != '' && !is_null($certificate->background_img)) { ?>
                                                        <img src="<?php echo base_url('uploads/marksheet/') ?><?php echo $certificate->background_img ?>" width="40">
                                                    <?php } else { ?>
