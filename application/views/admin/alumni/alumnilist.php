        ...
        <div class="row">
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if (array_key_exists($student['id'],$alumni_studets))
                                                                          {
            ...
            <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['dob'])); ?><br>
                                                                    ...
                                                                    <div class="col-xs-6 col-md-6">
                                                                        ...
                                                                        <b><?php echo $this->lang->line('current_phone'); ?>: </b> <abbr title="Phone"><i class="fa fa-phone-square"></i>&nbsp;</abbr> <?php if(array_key_exists($student['id'],$alumni_studets)) {
                                            echo  $alumni_studets[$student['id']]['current_phone'];
                                        }?><br>
                                                                        <b>
                                                                        <b><?php echo $this->lang->line('current_email'); ?>: </b> <abbr title="Phone">&nbsp;</abbr> <?php if(array_key_exists($student['id'],$alumni_studets)) {
                                            echo  $alumni_studets[$student['id']]['current_email'];
                                        }?><br>
                                                                        <b><?php echo $this->lang->line('current_address'); ?>:&nbsp;</b><?php if(array_key_exists($student['id'],$alumni_studets)) {
