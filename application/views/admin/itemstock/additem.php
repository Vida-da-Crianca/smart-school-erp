...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> <?php echo $this->lang->line('item'); ?></h1>
    </section>
                                        ...
                                        foreach ($itemlist as $items) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/item/add/<?php echo $items['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>">
