                                        ...
                                        foreach($resultlist as $value){?>
                                           ...
                                           <span style="display:none;" id="ratevalue"> <?php echo  $value['rate'] ; ?></span>
                                            ...
                                            if($this->rbac->hasPrivilege('teachers_rating','can_edit')){
                                                ...
                                                if($value['status']=='0'){ ?><a style="vertical-align: middle"  class="label label-info btn-xs btn" href="<?php echo base_url();?>admin/Staff/ratingapr/<?php echo $value['rate_id']?>"><?php echo $this->lang->line('approve'); ?></a><?php }else{ ?><?php } } 
