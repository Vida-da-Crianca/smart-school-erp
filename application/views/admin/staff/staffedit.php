                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $staff["name"]); ?> <?php echo set_value('surname', $staff["surname"]); ?>" />
                                        ...
                                        <?php if ($sch_setting->staff_current_address) { ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="address"  id="address-complete" class="form-control"><?php echo set_value('address', $staff["local_address"]) ?></textarea>
                                                    </div>
                                        ...
                                        <?php } if ($sch_setting->staff_permanent_address) { ?>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div><textarea name="permanent_address"  id="address-complete1" class="form-control"><?php echo set_value('permanent_address', $staff["permanent_address"]); ?></textarea>
                                                    </div>
                                                    <span class="text-danger"></span></div>
                                            </div>                          
