        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-tools pull-right">   
                        <a class="btn btn-primary btn-sm btn-info" data-toggle="tooltip" title="<?php echo $this->lang->line('cron_secret_key') ?>" href="<?php echo base_url()."admin/admin/addCronsecretkey/".$settinglist[0]['id'] ?>"><?php if(!empty($settinglist[0]['cron_secret_key'])){ echo $this->lang->line('regenerate'); }else{ echo $this->lang->line('generate'); } ?></a>
                     </div>   
