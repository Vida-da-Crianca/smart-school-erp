                ...
                <div class="">
                    ...
                    <table width="100%" class="paytable2">
                        <tr>
                            ...
                            <th class="text-right"></th> <th class="text-right"><?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('date'); ?>: <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['payment_date'])); ?></th>
