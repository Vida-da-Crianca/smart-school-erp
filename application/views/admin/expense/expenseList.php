                            ...
                            <form id="form1" action="<?php echo base_url() ?>admin/expense" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="date" name="payment_at" placeholder="" type="text" class="form-control date" value="<?php echo set_value('payment_at', date($this->customlib->getSchoolDateFormat())); ?>" />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form#form1').submit(function(e) {
                ...
                var obj = $('input[name="owner_id"]')
                if (obj.val() === '') {
                    alert('Selecione um fornecedor ou funcionário válidos')
                    e.preventDefault();
                    return;
                }
        ...
        function initializeAutocomplete() {
            ...
            $('input[name="name"]').autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    $('input[name="owner_id"]').data('item', ui.item || null)
                },
