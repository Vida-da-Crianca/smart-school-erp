...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/page/create') ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_page'); ?></h3>
                            ...
                            <div class="form-group">
                                ...
                                foreach ($category as $cat_key => $cat_value) {
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" value="<?php echo $cat_key ?>" name="content_category" <?php echo set_radio('content_category', $cat_key, (set_value('content_category', 'standard') == $cat_key) ? TRUE : FALSE ) ?> > <?php echo $this->lang->line($cat_key) ?> </label>
                                    <?php
                                }
                                ?>
