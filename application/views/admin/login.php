                    ...
                    <div class="row">
                        ...
                        <div class="<?php echo $bgoffsetbg; ?>">   
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 nopadding <?php echo $bgoffsetbgno; ?> <?php echo $offset; ?>">
                                ...
                                <p style="margin-top: 10px;"><a style="color:#000;" target="_blank" href="/userlogin" class="forgot pull-right"> <i class="fa fa-user"></i> Portal Aluno</a> <a style="color:#000; padding-right: 20px;" href="/" target="_blank" class="forgot pull-right">Site <i class="fa fa-empire"></i> </a>
                                 </p> 
