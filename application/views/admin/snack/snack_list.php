    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header" style="width: 100%;  display: flex; justify-content: space-between;">
                <div style="flex: 1;"><h3
                            class="box-title titlefix text-left"> <?php echo $this->lang->line('snack_generate_collection_list'); ?> </h3>
                </div>
                <div class="loader-i text-right">
                    <a href="<?php echo site_url('admin/snack/create') ?>"><span class="fa fa-plus"></span> Adicionar</a>
                </div>
            ...
            <div class="box-body">
                <div class="table-responsive mailbox-messages">
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        <thead>
                        <tr>
                            <th><?php echo $this->lang->line('snack_name'); ?></th>
                        ...
                        <?php foreach ($snacks as $item) : ?>
                            <tr>
                              ...
                              &nbsp; -->
                                    <a href="<?= site_url(sprintf('admin/snack/edit/%s', $item->id)) ?>">
