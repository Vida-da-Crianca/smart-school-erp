<div class="content-wrapper"> 
	...
	<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" id="<?php echo $edittopicname_value['id']; ?>"><label><?php echo $this->lang->line("topic")." ".$this->lang->line('name'); ?></label><small class="req"> *</small><input type="text" name="topic_<?php echo $edittopicname_value['id']; ?>" value="<?php echo $edittopicname_value['name']; ?>" style="width:95%" /><?php if($this->rbac->hasPrivilege('topic','can_delete')){?><span  onclick="remove_topic('<?php echo $edittopicname_value['id']; ?>')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span> <?php } ?></div>				
						...
						<div class="download_label"><?php echo $this->lang->line('topic')." ".$this->lang->line('list') ?></div>		  
							<a class="btn btn-default btn-xs pull-right" id="print" onclick="printDiv()" ><i class="fa fa-print"></i></a> <a class="btn btn-default btn-xs pull-right" id="btnExport" onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i> </a>
                             ...
                             <table class="table table-hover table-striped" id="headerTable">
                                ...
                                <tbody>
                                    <?php foreach($result as $key => $result_value){
 ...
 $(document).on('change', '#secid', function () {
  ...
  function getSubjectGroup(class_id, section_id, subjectgroup_id, subject_group_target) {
    ...
    function add_topic(){
        ...
        var id=makeid(8);
        $('#topic_result').append('<div class="form-group" id="'+id+'"><label><?php echo $this->lang->line("topic")." ".$this->lang->line("name"); ?></label><small class="req"> *</small><input type="text" name="topic[]" style="width:95%" /><span  onclick="remove_topic('+id+')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
    }
