...
<div class="pull-right">
	...
	if($this->rbac->hasPrivilege('link_exam','can_edit')){
		?>
		<button type="submit" class="btn btn-primary" id="load" name="save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..."><?php echo $this->lang->line('save'); ?></button>
		<?php
	}
	?>
