                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> 
                                                    ...
                                                    <?php if ($this->question_model->user_answer_check($q->id, $this->customlib->getUserData()['id'])) {  ?>
                                                        <?php $info = $this->question_model->user_answer_check($q->id, $this->customlib->getUserData()['id'])?>
...
<script>
    ...
    $("form#answer-form").submit(function (e) {
        ...
        $.ajax({
            type: "POST",
            url: base_url+'admin/questionnaires/answerAddAnswerUser',
            data: $(this).serialize(),
...
<script>
    ...
    function answerGetQuestion(quest_id) {
        ...
        $.ajax({
                type: "POST",
                url: base_url + "admin/questionnaires/answerGetQuestion",
