    ...
    foreach ($issued_books as $book) {
        ?>
                                           <tr   <?php if(strtotime($book['return_date'])<strtotime(date('Y-m-d'))){ ?>class="danger" <?php }?>>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php if($book['issue_date']!=''){ echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($book['issue_date'])); } ?></td>
                                                    <?php ?>
                                                <td class="mailbox-name">
                                                    <?php if($book['return_date']!=''){ echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($book['return_date'])); } ?></td>
                                                <td >
