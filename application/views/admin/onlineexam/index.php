                                ...
                                <table class="table table-striped table-bordered table-hover example">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($questionList as $subject_key => $subject_value) {
                                            ?>
                                            <tr>
                                                <td class="mailbox-name">   <a href="#" data-toggle="popover" class="detail_popover"><?php echo $subject_value->exam; ?></a>  <div class="fee_detail_popover" style="display: none">
                                                        <?php
                                                ...
                                                <td class="mailbox-name"> <?php echo $subject_value->total_ques; ?></td>
