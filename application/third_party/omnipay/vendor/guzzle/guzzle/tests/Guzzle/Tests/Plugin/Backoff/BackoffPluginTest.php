...
class BackoffPluginTest extends \Guzzle\Tests\GuzzleTestCase implements EventSubscriberInterface {
    ...
    public function testRetriesRequests() {
        ...
        $plugin = new BackoffPlugin(
                new TruncatedBackoffStrategy(3, new HttpBackoffStrategy(null, new CurlBackoffStrategy(null, new ConstantBackoffStrategy(0.05)
                )
                )
                )
        );
    ...
    public function testFailsOnTruncation() {
        ...
        $plugin = new BackoffPlugin(
                new TruncatedBackoffStrategy(2, new HttpBackoffStrategy(null, new ConstantBackoffStrategy(0.05)
                )
                )
        );
    ...
    public function testRetriesRequestsWhenInParallel() {
        ...
        $plugin = new BackoffPlugin(
                new HttpBackoffStrategy(null, new TruncatedBackoffStrategy(3, new CurlBackoffStrategy(null, new ConstantBackoffStrategy(0.1)
                )
                )
                )
        );
