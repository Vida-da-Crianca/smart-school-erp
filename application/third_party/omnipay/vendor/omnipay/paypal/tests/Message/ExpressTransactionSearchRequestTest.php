...
class ExpressTransactionSearchRequestTest extends TestCase {
    ...
    public function testWithoutStartDate() {
        ...
        $this->setExpectedException(
                '\Omnipay\Common\Exception\InvalidRequestException', 'The startDate parameter is required'
        );
    ...
    public function testAmountWithoutCurrency() {
        ...
        $this->setExpectedException(
                '\Omnipay\Common\Exception\InvalidRequestException', 'The currency parameter is required'
        );
