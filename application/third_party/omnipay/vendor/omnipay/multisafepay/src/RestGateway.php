...
class RestGateway extends AbstractGateway {
    ...
    public function fetchPaymentMethods(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestFetchPaymentMethodsRequest', $parameters
        );
    }
    ...
    public function fetchIssuers(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestFetchIssuersRequest', $parameters
        );
    }
    ...
    public function fetchTransaction(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestFetchTransactionRequest', $parameters
        );
    }
    ...
    public function refund(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestRefundRequest', $parameters
        );
    }
    ...
    public function purchase(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestPurchaseRequest', $parameters
        );
    }
    ...
    public function completePurchase(array $parameters = array()) {
        return $this->createRequest(
                        'Omnipay\MultiSafepay\Message\RestCompletePurchaseRequest', $parameters
        );
    }
