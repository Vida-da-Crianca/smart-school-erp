...
class vfsStreamDirectoryIssue18TestCase extends \PHPUnit_Framework_TestCase {
    ...
    public function shouldContainSubdirectoryFoo() {
        ...
        $this->assertInstanceOf('org\\bovigo\\vfs\\vfsStreamDirectory', $this->rootDirectory->getChild('var/log/app')->getChild('foo')
        );
    }
    ...
    public function shouldContainSubdirectoryApp1() {
        ...
        $this->assertInstanceOf('org\\bovigo\\vfs\\vfsStreamDirectory', $this->rootDirectory->getChild('var/log/app')->getChild('app1')
        );
    }
