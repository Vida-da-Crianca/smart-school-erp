          ...
          //  die('');
            ...
            if ($response) {
                ...
                if ($response->student_id != "") {
                    ...
                    $parent_login_detail = array('id' => $response->student_id, 'credential_for' => 'parent', 'username' => $this->parent_login_prefix . $response->student_id, 'password' =>  isset($parent_password) ? $parent_password : '123', 'contact_no' => $this->input->post('guardian_phone'), 'email' => $this->input->post('guardian_email'));
