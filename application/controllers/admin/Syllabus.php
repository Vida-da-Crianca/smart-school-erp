...
class Syllabus extends Admin_Controller {
    ...
    public function get_weekdates() {
        ...
        $prev_week_start = date("Y-m-d", strtotime('last monday', strtotime($this_week_start)));
        $next_week_start = date("Y-m-d", strtotime('next monday', strtotime($this_week_start)));
        $this_week_end = date("Y-m-d", strtotime('sunday this week', strtotime($this_week_start)));
    ...
    public function add_syllabus() {
        ...
        //$this->form_validation->set_rules('presentation',$this->lang->line('presentation'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $msg = array(
                ...
                // 'presentation'      => form_error('presentation'),
