...
class Studentfeemaster_model extends MY_Model
{
    ...
    public function getDueFeeByFeeSessionGroup($fee_session_groups_id, $student_fees_master_id)
    {
        ...
        LEFT JOIN billets on billets.fee_groups_feetype_id=fee_groups_feetype.id AND billets.user_id=student_fees_master.student_session_id AND billets.deleted_at IS NULL
