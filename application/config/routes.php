...
$route['admin/curriculos/deletar/(:num)']['get'] = 'admin/Staff/curriculo_deletar/$1'; // Deletar um c�rriculo do banco de dados
$route['admin/curriculos/pdf/(:num)']['get'] = 'admin/Staff/cv_pdf/$1'; // Gerar pdf do c�rriculo
