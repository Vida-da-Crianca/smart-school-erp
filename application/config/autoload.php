...
$autoload['libraries'] = array('database', 'email','session', 'form_validation', 'upload', 'pagination',
   'Customlib', 'Role', 'Smsgateway', 'QDMailer','Adler32','Aes','Tools');
 ...
 */
$autoload['helper'] = array('url', 'file', 'menu', 'security','application');
